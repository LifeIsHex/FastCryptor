...
* Notes:
  ...
  <b> Fast Cryptor comes with absolutely no guarantee. Use at your own risk. </b>
    ...
    * Fast Cryptor is a secure file encryption and decryption tool for Windows. In some cases, antivirus programs may flag Fast Cryptor as a potential threat due to its encryption capabilities.
    However, Fast Cryptor does not contain any malicious code or intent. It is a legitimate and safe tool for protecting sensitive files.
...
[>] 2.7.3 Build 30 (2023-02-12)
	...
	associate with .fcr files.
    [+] Added create a shortcut to the desktop.
    [+] Now entered password is more secure
	against memory attacks.
    [+] Improve file size calculation.
    [+] The source file shredder option is moved
...
[>] 2.2.5 Build 18 (2023-02-08)
    ...
    [+] Added password input length limitation.
	(max 32 characters)
...
If you found any bugs during usage, please submit the Issues. I will fix it ASAP.
